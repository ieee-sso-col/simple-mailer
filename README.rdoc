...
It was designed as an alternative of Mailchimp/Mandrill, and the main goal is sending transactional emails and supporting the communication platform for some IEEE conferences in SSO.
...
== Installation
    ...
    cp config/email_provider.yml.example config/email_provider.yml
